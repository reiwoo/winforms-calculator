...
{
    public partial class area_parallelogram : Bunifu.UI.WinForms.BunifuUserControl
    {
        private parallelogram parallelogramForm;
        public area_parallelogram()
        {
            InitializeComponent();
        }
        private void FormulaItem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (parallelogramForm == null || parallelogramForm.IsDisposed)
                {
                    parallelogramForm = new parallelogram();
                    parallelogramForm.Show();
                }
                else
                {
                    parallelogramForm.BringToFront();
                }
            }
        }
