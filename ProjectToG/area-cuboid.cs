...
{
    public partial class area_cuboid : Bunifu.UI.WinForms.BunifuUserControl
    {
        private parallelepiped parallelepipedForm;
        public area_cuboid()
        {
            InitializeComponent();
        }
        ...
        private void FormulaItem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (parallelepipedForm == null || parallelepipedForm.IsDisposed)
                {
                    parallelepipedForm = new parallelepiped();
                    parallelepipedForm.Show();
                }
                else
                {
                    parallelepipedForm.BringToFront();
                }
            }
        }
