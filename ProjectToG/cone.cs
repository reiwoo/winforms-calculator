...
namespace ProjectToG
{
    public partial class cone : Form
    {
        public cone()
        {
            ...
            this.MouseDown += new MouseEventHandler(cone_MouseDown);
            this.tabPage1.MouseDown += new MouseEventHandler(cone_MouseDown);
            this.tabPage2.MouseDown += new MouseEventHandler(cone_MouseDown);
            this.tabPage3.MouseDown += new MouseEventHandler(cone_MouseDown);
            this.tabPage4.MouseDown += new MouseEventHandler(cone_MouseDown);
            this.tabPage5.MouseDown += new MouseEventHandler(cone_MouseDown);
        }
        ...
        private void skControl1_PaintSurface(object sender, SkiaSharp.Views.Desktop.SKPaintSurfaceEventArgs e)
        {
            ...
            painter.LaTeX = @"Formula: V = \frac{1}{3}\pi r^{2}h";
        ...
        private void cone_MouseDown(object sender, MouseEventArgs e)
        {
