...
namespace ProjectToG
{
    public partial class tangle : Form
    {
        public tangle()
        {
            ...
            this.MouseDown += new MouseEventHandler(tangle_MouseDown);
            this.tabPage1.MouseDown += new MouseEventHandler(tangle_MouseDown);
            this.tabPage2.MouseDown += new MouseEventHandler(tangle_MouseDown);
            this.tabPage3.MouseDown += new MouseEventHandler(tangle_MouseDown);
            this.tabPage4.MouseDown += new MouseEventHandler(tangle_MouseDown);
            this.tabPage5.MouseDown += new MouseEventHandler(tangle_MouseDown);
        }
        ...
        private void tangle_MouseDown(object sender, MouseEventArgs e)
        {
