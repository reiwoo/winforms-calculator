...
{
    public partial class area_square : Bunifu.UI.WinForms.BunifuUserControl
    {
        private square squareForm;
        public area_square()
        {
            InitializeComponent();
        }
        private void FormulaItem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (squareForm == null || squareForm.IsDisposed)
                {
                    squareForm = new square();
                    squareForm.Show();
                }
                else
                {
