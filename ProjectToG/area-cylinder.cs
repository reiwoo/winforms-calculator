...
{
    public partial class area_cylinder : Bunifu.UI.WinForms.BunifuUserControl
    {
        private cylinder cylinderForm;
        public area_cylinder()
        {
            InitializeComponent();
        }
        private void FormulaItem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (cylinderForm == null || cylinderForm.IsDisposed)
                {
                    cylinderForm = new cylinder();
                    cylinderForm.Show();
                }
                else
                {
                    cylinderForm.BringToFront();
                }
            }
        }
