...
namespace ProjectToG
{
    public partial class prism : Form
    {
        public prism()
        {
            ...
            this.MouseDown += new MouseEventHandler(prism_MouseDown);
            this.tabPage1.MouseDown += new MouseEventHandler(prism_MouseDown);
            this.tabPage2.MouseDown += new MouseEventHandler(prism_MouseDown);
            this.tabPage3.MouseDown += new MouseEventHandler(prism_MouseDown);
            this.tabPage4.MouseDown += new MouseEventHandler(prism_MouseDown);
            this.tabPage5.MouseDown += new MouseEventHandler(prism_MouseDown);
        }
        ...
        private void prism_MouseDown(object sender, MouseEventArgs e)
        {
