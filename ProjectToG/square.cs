...
namespace ProjectToG
{
    public partial class square : Form
    {
        public square()
        {
            ...
            this.MouseDown += new MouseEventHandler(square_MouseDown);
            this.tabPage1.MouseDown += new MouseEventHandler(square_MouseDown);
            this.tabPage2.MouseDown += new MouseEventHandler(square_MouseDown);
            this.tabPage3.MouseDown += new MouseEventHandler(square_MouseDown);
            this.tabPage4.MouseDown += new MouseEventHandler(square_MouseDown);
            this.tabPage5.MouseDown += new MouseEventHandler(square_MouseDown);
        }
