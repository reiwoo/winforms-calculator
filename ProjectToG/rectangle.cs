...
namespace ProjectToG
{
    public partial class rectangle : Form
    {
        public rectangle()
        {
            ...
            this.MouseDown += new MouseEventHandler(rectangle_MouseDown);
            this.tabPage1.MouseDown += new MouseEventHandler(rectangle_MouseDown);
            this.tabPage2.MouseDown += new MouseEventHandler(rectangle_MouseDown);
            this.tabPage3.MouseDown += new MouseEventHandler(rectangle_MouseDown);
            this.tabPage4.MouseDown += new MouseEventHandler(rectangle_MouseDown);
            this.tabPage5.MouseDown += new MouseEventHandler(rectangle_MouseDown);
        }
